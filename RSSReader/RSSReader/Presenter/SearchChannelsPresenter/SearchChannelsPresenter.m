...
@property (nonatomic, strong) id<SearchChannelsServiceType> service;
@property (nonatomic, strong) id<ChannelsLocalStorageServiceType> localStorage;
@end
...
- (NSIndexSet *)alreadyAddedChannelsIndexesForChannels:(NSArray<RSSChannel *> *)channels {
    ...
    return [alreadyAddedIndexes copy];
}
